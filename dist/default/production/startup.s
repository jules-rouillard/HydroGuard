	...
	; Compiler options:
	;
	; -q --opt=none --chip=18f16q41 \
	; -Mdist/default/production/HydroGuard.production.map \
	; -DXPRJ_default=default -L--defsym=__MPLAB_BUILD=1 \
	; --dfp=C:/Users/Jules/.mchp_packs/Microchip/PIC18F-Q_DFP/1.25.433/xc8 \
	...
	; -oHydroGuard.production.elf --objdir=dist/default/production \
	...
	; build/default/production/dht.p1 -L--fixupoverflow=error \
	...
	processor	18F16Q41
	include "C:/Users/Jules/.mchp_packs/Microchip/PIC18F-Q_DFP/1.25.433/xc8\pic\include\proc\18f16q41.cgen.inc"
